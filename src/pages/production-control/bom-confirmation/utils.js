...
export const restoreOutboundsToAllocations = ({
  ...
  outbounds.map((outbound, index) => {
    ...
    return {
      ...
      warehouseName: outbound.wareHouseStock?.name,
      warehouseAddress: outbound.wareHouseStock?.address,
...
export const buildAllocationEntry = ({
  ...
  warehouseName: inventory.wareHouseStock?.name,
  warehouseAddress: inventory.wareHouseStock?.address,
