...
const CateSanPham = () => {
  ...
  const canCreate = hasPermission('web.product_category.create');
  const canUpdate = hasPermission('web.product_category.update');
  const canDelete = hasPermission('web.product_category.delete');
